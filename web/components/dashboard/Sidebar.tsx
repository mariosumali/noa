...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-card border-r border-card-border flex flex-col h-screen sticky top-0">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-card-border">
        <form action={logout}>
          <button
            type="submit"
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-muted hover:text-foreground hover:bg-card-border/50 transition-colors w-full"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
